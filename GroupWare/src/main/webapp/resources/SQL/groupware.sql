...
-- #1.회원정보
insert into employees_table(employee_seq,employee_name,employee_id,employee_pw,email,phone,fk_status,hire_date,fk_position,grade)
values(1,'관리자','admin','qwer1234$','admin@eclass.net','01023456789',1,default,default,default);
...
select calendar_seq, title, content, to_char('startDate', 'yyyy-mm-dd' || 'T' || 'hh24:mi') AS startDate
			 , to_char('endDate', 'yyyy-mm-dd' || 'T' || 'hh24:mi') AS endDate , color
from personalCalendar_table;

insert into personalCalendar_table(calendar_seq, fk_employee_seq, title, content, startDate, endDate, color)
values(personalCalendar_table_seq.nextval, '1', '파이널 프로젝트 2주차', '캘린더DB연동', to_date('2020-08-04 13:00:00', 'yyyy-mm-dd hh24:mi:ss'), to_date('2020-08-04 14:00:00', 'yyyy-mm-dd hh24:mi:ss'), '#D25565');
