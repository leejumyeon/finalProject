...
<style type="text/css">
	...
	<div id="container">
		...
		<div id="post">	
			...
			<div id="button" >
				<button style="color: white; margin-left: 10px; width: 70px;" type="button" onclick="javascript:location.href=''">목록보기</button>
				<button style="color: white; margin-left: 10px; width: 70px;" type="button" onclick="javascript:location.href=''">수정</button>
				<button style="color: white; margin-left: 10px; width: 70px;" type="button" onclick="javascript:location.href=''">삭제</button>
			</div>
			</div>
		</div>
	</div>	