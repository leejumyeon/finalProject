...
<style type="text/css">
	...
	table, th, td, input, textarea {border: solid #d9d9d9 1px;}
	
	#table {border-collapse: collapse; width: 900px;}
	#table th, #table td{padding: 5px;}
	#table th{width: 120px; background-color: #1187cf; font-size: 11pt; color: white; text-align: center;}
	#table td{width: 860px;}
	.long {width: 470px;}
	.short {width: 120px;}
	div > button {color: white; border-radius: 0; border: none; background: #1187cf; padding: 7px;}
...
<script type="text/javascript">
	...
	function goPrint(title) {
		...
		var popw = 800; // 팝업창 가로 길이
		var poph = 600; // 팝업창의 세로길이
		...
		// 팝업윈도우창에 내용을 입력한다.
		popWin.document.write("<html><head><style type='text/css'>*{color:red;}</style><body onload='window.print()'>"); 
		...
		<table id="table">
			<tr>
				...
				<td>
					...
					<input type="text" name="name" value="${sessionScope.loginuser.name}" class="short" />           
				</td>
			</tr>
