...
<div id="divCustomWrapper" style="font-family: &quot;맑은 고딕&quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
	...
	<div class="titleSection">매출 구매서</div>
...
<table style="width: 100%; border: 2px solid rgb(0, 0, 0); font-family: malgun gothic, dotum, arial, tahoma; margin-top: 1px; border-collapse: collapse;">
	<tbody>
		<tr>
			<td class="ACel">
				<span style="font-size: 10pt;">매 출 구 분</span>
			</td>
		...
		<tr>
			<td class="ACel">
				<span style="font-size: 10pt;">매출 금액</span>
			</td>
			<td class="BCel" colspan="3">
				<span style="font-size: 10pt;"></span>
			</td>
...
<table style="border: 2px solid rgb(0, 0, 0); width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; border-collapse: collapse;">
	<tbody>
		<tr>
			<td class="ACel">
				<span style="font-size: 10pt;">품&nbsp;&nbsp;&nbsp;&nbsp;목</span>
			</td>
			<td class="ACel">
				<span style="font-size: 10pt;">수&nbsp;&nbsp;&nbsp;&nbsp;량</span>
			</td>
			<td class="ACel">
				<span style="font-size: 10pt;">매&nbsp;출&nbsp;금&nbsp;액</span>
			</td>
		</tr>
		<tr>
			<td class="BCel">
		...
		<tr>
			<td class="ACel" colspan="2">
				<span style="font-size: 10pt;">총 매출 합계</span>
			</td>
			<td class="BCel">
				<span style="font-size: 10pt;"></span>
			</td>
...
<table style="border: 2px solid rgb(0, 0, 0); width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; margin-top: 1px; border-collapse: collapse;">
	<tbody>
		...
		<tr>
			<td class="ACel" colspan="2">
				<span style="font-size: 10pt;">총 지출 합계</span>
			</td>
			<td class="BCel">
				<span style="font-size: 10pt;"></span>
			</td>
