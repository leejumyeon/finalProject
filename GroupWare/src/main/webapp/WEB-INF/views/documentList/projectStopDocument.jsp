...
<div id="divCustomWrapper" style="font-family: &quot;맑은 고딕&quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
	...
	<div class="titleSection">프로젝트 중단 기안서</div>
	...
	<div id="documentContents">
		...
		<table class="detailSection">
			<tbody>
				<tr>
					<td class="ACel" style="width: 160px;">
				...
				<tr>
					<td class="ACel" style="width: 160px;">
						<span style="font-weight: bold; font-size: 11pt;">프로젝트 중단 사유</span>
					</td>
					<td class="BCel" colspan="3">
						<textarea rows="5" cols="110" name="reason" style="border: none;"></textarea>
					</td>
				</tr>
				<tr>
					<td class="ACel" style="width: 160px;">
					...
					<td class="BCel" colspan="3">
						<input type="text" name="middlePayment" style="width: 400px; height: 30px; border: none;" autocomplete="off"/>
					</td>
				</tr>
				<tr>
					<td class="BCel" colspan="4" style="text-align: center;">
						<span style="font-size: 12pt; font-style: italic; font-weight: bold;">위와 같은 사유로 프로젝트가 중단 되었음을 보고합니다.</span>
						<br>
